...
ansible_extra_args        = ["-e", "@extra/playbooks/provision_rocky8_variables.yml", "-e", "@variables/rockylinux8.yml","--scp-extra-args", "'-O'"]
ansible_verbosity         = ["-v"]
...
iso_file                  = "images:iso/Rocky-8.10-x86_64-dvd1.iso"
memory                    = "4096"
network_adapters = {
    bridge                = "vmbr0"
    model                 = "virtio"
